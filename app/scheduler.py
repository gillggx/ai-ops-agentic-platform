...
async def run_routine_check_job(check_id: int, base_url: str = "") -> Dict[str, Any]:
    ...
    from app.ontology.models.event import EventType as EventTypeModel
    from app.ontology.repositories.routine_check_repository import RoutineCheckRepository
    from app.ontology.repositories.generated_event_repository import GeneratedEventRepository
