...
from app.ontology.repositories.routine_check import RoutineCheckRepository
...
from app.ontology.schemas.routine_check import (
    RoutineCheckCreate,
...
router = APIRouter(prefix="/api/v1/routine-checks", tags=["routine-checks"])
