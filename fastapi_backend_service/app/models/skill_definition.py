...
class SkillDefinitionModel(Base):
    ...
    # Short description of the item/object being monitored (e.g. "TETCH01 蝕刻機台")
    problem_subject: Mapped[Optional[str]] = mapped_column(String(300), nullable=True, default=None)
