/**
 * Design tokens for the System MCP admin screens — single source of truth for
 * the "1a · Clarity" visual language (indigo accent, card surfaces, mono data).
 * Fonts use system fallbacks (no Google Fonts) per the adopted-design decision.
 *
