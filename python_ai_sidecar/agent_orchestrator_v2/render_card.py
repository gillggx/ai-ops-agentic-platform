...
from python_ai_sidecar.agent_orchestrator_v2.helpers import _notify_chart_rendered
...
def _build_render_card(
    ...
    if tool_name == "execute_skill" and isinstance(result, dict) and "ui_render_payload" in result:
        ...
        if chart_intents:
            ...
            from python_ai_sidecar.agent_orchestrator_v2.nodes.tool_execute import _chart_intent_to_vega_lite
            visualization = []
