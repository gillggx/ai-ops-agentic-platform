...
const DC_GROUPS: SensorGroup[] = [
  {
    ...
    color: "sky",
    sensors: [
      { key: "sensor_01", label: "Chamber Press",    unit: "mTorr" },
      { key: "sensor_02", label: "Foreline Press",   unit: "mTorr" },
      { key: "sensor_03", label: "Load Lock Press",  unit: "mTorr" },
      { key: "sensor_04", label: "Transfer Press",   unit: "mTorr" },
      { key: "sensor_05", label: "Throttle Pos",     unit: "%" },
      { key: "sensor_06", label: "Gate Valve Pos",   unit: "%" },
    ],
  },
  {
    title: "Thermal",
    color: "orange",
    sensors: [
      { key: "sensor_07", label: "ESC Zone1 Temp",   unit: "°C" },
      { key: "sensor_08", label: "ESC Zone2 Temp",   unit: "°C" },
      { key: "sensor_09", label: "ESC Zone3 Temp",   unit: "°C" },
      { key: "sensor_10", label: "Chuck Temp",        unit: "°C" },
      { key: "sensor_11", label: "Wall Temp",         unit: "°C" },
      { key: "sensor_12", label: "Ceiling Temp",      unit: "°C" },
      { key: "sensor_13", label: "Gas Inlet Temp",    unit: "°C" },
      { key: "sensor_14", label: "Exhaust Temp",      unit: "°C" },
    ],
  },
  {
    title: "Power",
    color: "violet",
    sensors: [
      { key: "sensor_15", label: "Source Power HF",  unit: "W" },
      { key: "sensor_16", label: "Source Refl HF",   unit: "W" },
      { key: "sensor_17", label: "Bias Power LF",    unit: "W" },
      { key: "sensor_18", label: "Bias Refl LF",     unit: "W" },
      { key: "sensor_19", label: "Bias Voltage",     unit: "V" },
      { key: "sensor_20", label: "Bias Current",     unit: "A" },
      { key: "sensor_21", label: "Source Freq",      unit: "MHz" },
      { key: "sensor_22", label: "Match Cap C1",     unit: "pF" },
    ],
  },
  {
    title: "Gas Flow",
    color: "emerald",
    sensors: [
      { key: "sensor_23", label: "CF4 Flow",         unit: "sccm" },
      { key: "sensor_24", label: "O2 Flow",          unit: "sccm" },
      { key: "sensor_25", label: "Ar Flow",          unit: "sccm" },
      { key: "sensor_26", label: "N2 Flow",          unit: "sccm" },
      { key: "sensor_27", label: "He Flow",          unit: "sccm" },
      { key: "sensor_28", label: "CHF3 Flow",        unit: "sccm" },
      { key: "sensor_29", label: "C4F8 Flow",        unit: "sccm" },
      { key: "sensor_30", label: "Total Flow",       unit: "sccm" },
    ],
  },
];
...
const APC_GROUPS: SensorGroup[] = [
  {
    ...
    color: "sky",
    sensors: [
      { key: "param_01", label: "R2R Bias",          unit: "nm" },
      { key: "param_02", label: "R2R Gain",          unit: "" },
      { key: "param_03", label: "R2R Offset",        unit: "nm" },
      { key: "param_04", label: "Model Intercept",   unit: "" },
    ],
  },
  {
    ...
    color: "orange",
    sensors: [
      { key: "param_05", label: "Target CD",         unit: "nm" },
      { key: "param_06", label: "Target EPD",        unit: "s" },
      { key: "param_07", label: "Etch Rate",         unit: "nm/min" },
      { key: "param_08", label: "Uniformity",        unit: "%" },
    ],
  },
  {
    title: "Feed-Forward",
    color: "violet",
    sensors: [
      { key: "param_09", label: "FF Correction",     unit: "" },
      { key: "param_10", label: "FF Weight",         unit: "" },
      { key: "param_11", label: "FF Alpha",          unit: "" },
      { key: "param_12", label: "Lot Weight",        unit: "" },
    ],
  },
  {
    ...
    color: "emerald",
    sensors: [
      { key: "param_13", label: "FB Correction",     unit: "" },
      { key: "param_14", label: "FB Alpha",          unit: "" },
      { key: "param_15", label: "Model R²",          unit: "" },
      { key: "param_16", label: "Stability Index",   unit: "" },
      { key: "param_17", label: "Prediction Error",  unit: "" },
      { key: "param_18", label: "Convergence Idx",   unit: "" },
      { key: "param_19", label: "Reg λ",             unit: "" },
      { key: "param_20", label: "Response Factor",   unit: "" },
    ],
  },
];
...
const RECIPE_GROUPS: SensorGroup[] = [
  {
    ...
    color: "sky",
    sensors: [
      { key: "param_01", label: "Etch Time",         unit: "s" },
      { key: "param_02", label: "Etch Depth",        unit: "nm" },
      { key: "param_03", label: "Etch Rate",         unit: "nm/s" },
      { key: "param_04", label: "CD Bias",           unit: "nm" },
      { key: "param_05", label: "Over-Etch",         unit: "%" },
    ],
  },
  {
    ...
    color: "orange",
    sensors: [
      { key: "param_06", label: "Process Press",     unit: "mTorr" },
      { key: "param_07", label: "Base Press",        unit: "mTorr" },
      { key: "param_08", label: "Chamber Temp",      unit: "°C" },
      { key: "param_09", label: "Wall Temp",         unit: "°C" },
    ],
  },
  {
    title: "Gas Setpoints",
    color: "emerald",
    sensors: [
      { key: "param_10", label: "CF4 Setpoint",      unit: "sccm" },
      { key: "param_11", label: "O2 Setpoint",       unit: "sccm" },
      { key: "param_12", label: "Ar Setpoint",       unit: "sccm" },
      { key: "param_13", label: "He Setpoint",       unit: "sccm" },
    ],
  },
  {
    title: "RF Power",
    color: "violet",
    sensors: [
      { key: "param_14", label: "Source Power",      unit: "W" },
      { key: "param_15", label: "Bias Power",        unit: "W" },
      { key: "param_16", label: "Source Freq",       unit: "MHz" },
      { key: "param_17", label: "Bias Freq",         unit: "kHz" },
      { key: "param_18", label: "EPD Threshold",     unit: "" },
      { key: "param_19", label: "Min Etch Time",     unit: "s" },
      { key: "param_20", label: "Max Etch Time",     unit: "s" },
    ],
  },
];
